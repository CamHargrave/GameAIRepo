...
public class SimpleFSM : FSM
{
    ...
    protected override void FSMUpdate()
    {
        switch (curState)
        {
            ...
            case FSMState.Watching: UpdateWatchingState(); break;
        }
    ...
    /// 
        ...
        // AI tank stops at the current WanderPoint to inspect it's surroundings.
    protected void UpdateWatchingState()
    {
        //stops movement
        curSpeed = 0;
        //Subratcts from timer
        Waiting--;
        //Once Waiting is done it moves on
        if(Waiting == 0)
        {
            curSpeed = 150.0f;
            FindNextPoint();
